...
After training your model, you have to host it as an endpoint on AWS Sagemaker.

Add the name of your endpoint to function.

Give your function access to the endpoint by:

In the AWS Lambda Console, find your created lambda function. Head over to the permissions tab and click on the role.
In the IAM Console, add a AmazonSagemakerFullAccess policy to your function.